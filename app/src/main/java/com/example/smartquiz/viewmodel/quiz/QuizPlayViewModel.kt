 ...
 * QuizPlayViewModel
 *
 * This ViewModel controls the entire quiz play flow.
 *
 * Responsibilities:
 * - Load questions and options
 * - Track current question
 * - Store user-selected answers (in memory)
 * - Track elapsed time (stopwatch)
...
class QuizPlayViewModel @Inject constructor(
    ...
    // Stores answers as: questionId -> selectedOptionId
    ...
    // Cache options per question for scoring
    ...
    // Formatted time for UI (HH:MM:SS)
    ...
    /**
     * Called once when user presses Submit.
     */
