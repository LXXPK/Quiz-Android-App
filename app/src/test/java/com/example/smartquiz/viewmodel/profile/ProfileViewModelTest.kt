...
import com.example.smartquiz.util.MainDispatcherRule
...
class ProfileViewModelTest {
    ...
    @Test
    fun `loadProfile success updates all states`() {
        runTest {
            val userId = "uid123"
    ...
    @Test
    fun `loadProfile without session sets error message`() {
        runTest {
    ...
    @Test
    fun `saveInterests success updates interests`() {
        runTest {
            val userId = "uid123"
    ...
    @Test
    fun `saveInterests failure sets error message`() {
        runTest {
            val userId = "uid123"
